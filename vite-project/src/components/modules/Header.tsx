    ...
    return (
        <div className={'w-full h-full flex justify-start items-start'}>
            <div className={'w-full h-full flex justify-between flex-col items-start'}>
                {/* Navigation */}
                <div className={'w-full bg-[rgb(var(--secondary-background))]'}>
                    <ul className={'p-2 flex flex-row flex-wrap justify-between items-center text-[rgb(var(--text-color))] text-sm'}>
