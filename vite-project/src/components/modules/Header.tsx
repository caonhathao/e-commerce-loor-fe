...
<div className={'w-full h-full flex justify-start items-start'}>
  <div className={'w-full h-full flex justify-between flex-col items-start'}>
    ...
    {/* Logo và Tiêu đề */}
    <div className={'w-full flex flex-row justify-between items-center bg-[var(--bg-color)]'}>
      <div className='w-[30%] p-3 rounded-full'>
        <img src={logo} alt='logo' className='w-[50%]' />
      </div>
      <div className='w-[70%]'>
        <p className='text-center font-bold text-[var(--main-color)] text-xl tracking-wide'>LOLI SHOPPING</p>
      </div>
    ...
    {/* Search & Icons */}
      ...
      <div className={'w-[10%] text-center'}>
        <button className='text-[var(--main-color)] border-2 border-[var(--border-color)] p-2 rounded-full'>
          <BsPerson size={25} />
        </button>
      </div>
</div>
