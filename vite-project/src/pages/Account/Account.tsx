    ...
    return (
        <div className={'flex flex-col items-center justify-start w-full min-h-screen'}>
            <div className="flex flex-col md:flex-row md:w-[80%] items-center justify-start md:justify-between w-full">
                <div className={'w-[50%] md:w-[40%] p-3 rounded-lg text-center border-2 border-[var(--bg-color)] flex flex-col justify-center items-center show-up-anim my-5'} style={{animationFillMode: 'forwards', animationDelay: '0s'}}>
                    <img style={{width:'30%'}} src={accountImg} alt={'logo'}/>
                    <h3 className={'text-[var(--text-color)] border-b-2 border-[(var(--bg-color)] font-bold'}>For customer's account</h3>
                    <div className={'text-[var(--text-color)]'}><Link to={'/sign-in'}>Đăng nhập</Link></div>
                    <div className={'text-[var(--text-color)]'}><Link to={'/sign-up'}>Đăng ký</Link></div>
                </div>
