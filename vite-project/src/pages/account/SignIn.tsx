...
import '../../assets/css/pages/account/SignIn.css'
...
function SignIn() {
    ...
    const formData = useFormik({
        ...
        validationSchema: Yup.object({
            account_name: Yup.string().min(6, 'Your account name must be at least 6 characters').max(10, 'Your account name must be under 10 characters').required('Your account name is required'),
            email: Yup.string().email('Your email is invalid').required('Your account email is required'),
    ...
    return (
        <div className="sign-in-container">
            <div className={'header'}>
                <div className={'header-banner'}>TOKO Shopping</div>
                ...
                <div className={'sign-in-form'}>
                    <form className={'form-css'} onSubmit={formData.handleSubmit}>
                        ...
                        {formData.errors.account_name && formData.touched.account_name && (
                            <p style={{margin: '1px 0', padding: '0'}}><small
                        ...
                        <div style={{
                            ...
                            <Link to={'/sign-up'}>You are our member? Login in here</Link>
                        </div>
                    </form>
                </div>
            </div>
